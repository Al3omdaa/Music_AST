...
import config
from Al3omdaMusic import Carbon, YouTube, app
from Al3omdaMusic.core.call import Al3omda
from Al3omdaMusic.misc import db
from Al3omdaMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Al3omdaMusic.utils.exceptions import AssistantErr
from Al3omdaMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from Al3omdaMusic.utils.inline.playlist import close_markup
from Al3omdaMusic.utils.pastebin import Al3omdabin
from Al3omdaMusic.utils.stream.queue import put_queue, put_queue_index
from Al3omdaMusic.utils.thumbnails import gen_thumb
...
async def stream(
    ...
    if forceplay:
        await Al3omda.force_stop_stream(chat_id)
