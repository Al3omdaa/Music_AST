...
from AL3omaMusic import YouTube, app
from AL3omaMusic.utils.decorators.language import language, languageCB
from AL3omaMusic.utils.formatters import convert_bytes
from AL3omaMusic.utils.inline.song import song_markup
...
async def song_helper_cb(client, CallbackQuery, _):
    ...
    if stype == "audio":
        ...
        try:
            ...
            return await CallbackQuery.edit_message_text(_["song_7"])
        keyboard = InlineKeyboard()
        # AVC Formats Only [ AL3OMDA MUSIC BOT ]
